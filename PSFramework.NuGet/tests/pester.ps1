...
Remove-Module PSFramework.NuGet -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSFramework.NuGet.psd1"
Import-Module "$PSScriptRoot\..\PSFramework.NuGet.psm1" -Force
